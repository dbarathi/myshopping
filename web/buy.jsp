<%-- 
    Document   : buy
    Created on : Dec 11, 2012, 10:16:13 AM
    Author     : dbarathi
--%>
...
<br><br>
<center><form name="buy" action="purchase.jsp" method="post">

    Enter the Item ID <input type="text" name="id" size="10">
    Enter the no of items<input type="text" name="quan"size="10">
